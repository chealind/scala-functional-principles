...
class AnagramsSuite {
  ...
  @Test def `sentenceOccurrences: 'Never have I ever'`(): Unit =
    assertEquals(List(('a', 1), ('e', 5), ('h', 1), ('i', 1), ('n', 1), ('r', 2), ('v', 3)), sentenceOccurrences(List("Never", "have", "I", "ever")))
  ...
  @Test def `subtract: lard - ()`(): Unit = {
    val lard = List(('a', 1), ('d', 1), ('l', 1), ('r', 1))
    assertEquals(lard, subtract(lard, List()))
  }
  ...
  @Test def `subtract: never - e`(): Unit = {
    val never = List(('e', 2), ('n', 1), ('r', 1), ('v', 1))
    val e = List(('e', 1))
    val nver = List(('e', 1), ('n', 1), ('r', 1), ('v', 1))
    assertEquals(nver, subtract(never, e))
  }
